...
cred = credentials.Certificate("serviceAccountKey.json")# download service account key by creating your project on firebase 
firebase_admin.initialize_app(cred, {
    'databaseURL': os.getenv("DBurl"),
    'storageBucket': os.getenv("Bucket")# images should be uploaded on storage bucket 
            ...
            for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
                ...
                if matches[matchIndex]:
                    ...
                    if can_mark_attendance(id):
                        ...
                        ws.append([id, student_info['name'], student_info['total_attendance'], datetime_now, student_info['year'], student_info['starting_year']])
